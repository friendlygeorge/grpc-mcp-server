...
import type { ServiceInfo, MethodInfo } from "./context.js";
 ...
 */
function loadReflectionProto(): grpc.ServiceClientConstructor {
...
function getMethodType(method: any): MethodInfo["type"] {
  if (method.clientStreaming && method.serverStreaming) return "bidi_streaming";
