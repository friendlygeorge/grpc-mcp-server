 ...
 */
import { z } from "zod";
export function registerDescriptorTools(server, ctx) {
    server.tool("get_service_descriptor", "Get the full descriptor for a gRPC service including all methods, request/response types, and streaming modes", {
        service_name: z
            .string()
